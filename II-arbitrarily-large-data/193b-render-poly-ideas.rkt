...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname 193b-render-poly-ideas) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; Ex. 193: render-poly could add the first item of p to the end of p via
;; a version of add-at-end that works on Polygons.
...
(define (render-poly img p)
  (connect-dots img (add-at-end p (first p)))) ; add the first point at the end
