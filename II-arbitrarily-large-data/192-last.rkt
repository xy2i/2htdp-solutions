...
;; Ex. 192: Why is it acceptable to use first as a stub for last?
;; Why use the template from connect-dots?
; first will always be correct for a data definition of NELoP.
; It will also be for all Polygons, since all Polygons are NELoPs.
; We can use the template from connect-dots since the class of data is the same (a NELoP.)