...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname 102-other-repr) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define UFO-JUMPINESS 12) ; how much an ufo can jump around each tick
